...
package-debian: code
	mkdir -p erlang_couchdb/usr/lib/erlang/lib/erlang_couchdb-0.2.1/ebin/ && cp erlang_couchdb.beam erlang_couchdb/usr/lib/erlang/lib/erlang_couchdb-0.2.1/ebin/erlang_couchdb.beam
